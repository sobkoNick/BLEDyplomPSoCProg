...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=14, Polarity=1, Resolution=7, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=capsense:IDAC2, CY_INSTANCE_SHORT_NAME=IDAC2, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=capsense_IDAC2, )
...
// IDAC_P4_v1_10(IDACRange=0, IDACValue=16, Polarity=1, Resolution=8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=IDAC_P4_v1_10, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=capsense:IDAC1, CY_INSTANCE_SHORT_NAME=IDAC1, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=true, CY_VERSION=PSoC Creator  4.0 Update 1, INSTANCE_NAME=capsense_IDAC1, )
...
module top ;
	...
	wire [0:0] tmpOE__Pin_l293_IC1_EN_12_net;
	wire [0:0] tmpFB_0__Pin_l293_IC1_EN_12_net;
	wire [0:0] tmpIO_0__Pin_l293_IC1_EN_12_net;
	wire [0:0] tmpINTERRUPT_0__Pin_l293_IC1_EN_12_net;
	electrical [0:0] tmpSIOVREF__Pin_l293_IC1_EN_12_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d2bacfab-4211-44d5-9c07-180b673585c9"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_l293_IC1_EN_12
		 (.oe(tmpOE__Pin_l293_IC1_EN_12_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_l293_IC1_EN_12_net[0:0]}),
		  .io({tmpIO_0__Pin_l293_IC1_EN_12_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_l293_IC1_EN_12_net),
		  .interrupt({tmpINTERRUPT_0__Pin_l293_IC1_EN_12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_l293_IC1_EN_12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_l293_IC1_EN_34_net;
	wire [0:0] tmpFB_0__Pin_l293_IC1_EN_34_net;
	wire [0:0] tmpIO_0__Pin_l293_IC1_EN_34_net;
	wire [0:0] tmpINTERRUPT_0__Pin_l293_IC1_EN_34_net;
	electrical [0:0] tmpSIOVREF__Pin_l293_IC1_EN_34_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a5b99d9e-dc2d-494e-9c89-665eba6a8566"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_l293_IC1_EN_34
		 (.oe(tmpOE__Pin_l293_IC1_EN_34_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_l293_IC1_EN_34_net[0:0]}),
		  .io({tmpIO_0__Pin_l293_IC1_EN_34_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_l293_IC1_EN_34_net),
		  .interrupt({tmpINTERRUPT_0__Pin_l293_IC1_EN_34_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_l293_IC1_EN_34_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_l293_IC2_EN_12_net;
	wire [0:0] tmpFB_0__Pin_l293_IC2_EN_12_net;
	wire [0:0] tmpIO_0__Pin_l293_IC2_EN_12_net;
	wire [0:0] tmpINTERRUPT_0__Pin_l293_IC2_EN_12_net;
	electrical [0:0] tmpSIOVREF__Pin_l293_IC2_EN_12_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("c15771a3-58ac-4597-beea-8fad0a0d2e99"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_l293_IC2_EN_12
		 (.oe(tmpOE__Pin_l293_IC2_EN_12_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_l293_IC2_EN_12_net[0:0]}),
		  .io({tmpIO_0__Pin_l293_IC2_EN_12_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_l293_IC2_EN_12_net),
		  .interrupt({tmpINTERRUPT_0__Pin_l293_IC2_EN_12_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_l293_IC2_EN_12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_l293_IC2_EN_34_net;
	wire [0:0] tmpFB_0__Pin_l293_IC2_EN_34_net;
	wire [0:0] tmpIO_0__Pin_l293_IC2_EN_34_net;
	wire [0:0] tmpINTERRUPT_0__Pin_l293_IC2_EN_34_net;
	electrical [0:0] tmpSIOVREF__Pin_l293_IC2_EN_34_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("fe497157-e942-47cf-9557-52b7d9541524"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_l293_IC2_EN_34
		 (.oe(tmpOE__Pin_l293_IC2_EN_34_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_l293_IC2_EN_34_net[0:0]}),
		  .io({tmpIO_0__Pin_l293_IC2_EN_34_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_l293_IC2_EN_34_net),
		  .interrupt({tmpINTERRUPT_0__Pin_l293_IC2_EN_34_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_l293_IC2_EN_34_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_OE_net;
	wire [0:0] tmpFB_0__Pin_OE_net;
	wire [0:0] tmpIO_0__Pin_OE_net;
	wire [0:0] tmpINTERRUPT_0__Pin_OE_net;
	electrical [0:0] tmpSIOVREF__Pin_OE_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("34530cd5-7e25-4fbf-9bb2-a85fae1619b4"),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_OE
		 (.oe(tmpOE__Pin_OE_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_OE_net[0:0]}),
		  .io({tmpIO_0__Pin_OE_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_OE_net),
		  .interrupt({tmpINTERRUPT_0__Pin_OE_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_OE_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_RCLK_net;
	wire [0:0] tmpFB_0__Pin_RCLK_net;
	wire [0:0] tmpIO_0__Pin_RCLK_net;
	wire [0:0] tmpINTERRUPT_0__Pin_RCLK_net;
	electrical [0:0] tmpSIOVREF__Pin_RCLK_net;

	cy_psoc3_pins_v1_10
		#(.id("ebcd90cb-b809-461c-894f-1efbe1166332"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_RCLK
		 (.oe(tmpOE__Pin_RCLK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_RCLK_net[0:0]}),
		  .io({tmpIO_0__Pin_RCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_RCLK_net),
		  .interrupt({tmpINTERRUPT_0__Pin_RCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_RCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_not_SRCLR_net;
	wire [0:0] tmpFB_0__Pin_not_SRCLR_net;
	wire [0:0] tmpIO_0__Pin_not_SRCLR_net;
	wire [0:0] tmpINTERRUPT_0__Pin_not_SRCLR_net;
	electrical [0:0] tmpSIOVREF__Pin_not_SRCLR_net;

	cy_psoc3_pins_v1_10
		#(.id("5439b156-a107-4547-be79-13454a629366"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_not_SRCLR
		 (.oe(tmpOE__Pin_not_SRCLR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_not_SRCLR_net[0:0]}),
		  .io({tmpIO_0__Pin_not_SRCLR_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_not_SRCLR_net),
		  .interrupt({tmpINTERRUPT_0__Pin_not_SRCLR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_not_SRCLR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SRCLK_net;
	wire [0:0] tmpFB_0__Pin_SRCLK_net;
	wire [0:0] tmpIO_0__Pin_SRCLK_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SRCLK_net;
	electrical [0:0] tmpSIOVREF__Pin_SRCLK_net;

	cy_psoc3_pins_v1_10
		#(.id("43aca68e-9e8e-4913-b5bd-650bd0f6ae07"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SRCLK
		 (.oe(tmpOE__Pin_SRCLK_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SRCLK_net[0:0]}),
		  .io({tmpIO_0__Pin_SRCLK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SRCLK_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SRCLK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SRCLK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_SER_net;
	wire [0:0] tmpFB_0__Pin_SER_net;
	wire [0:0] tmpIO_0__Pin_SER_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SER_net;
	electrical [0:0] tmpSIOVREF__Pin_SER_net;

	cy_psoc3_pins_v1_10
		#(.id("db094ded-63a6-4ca3-b08a-9e061d42f0b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_SER
		 (.oe(tmpOE__Pin_SER_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_SER_net[0:0]}),
		  .io({tmpIO_0__Pin_SER_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_SER_net),
		  .interrupt({tmpINTERRUPT_0__Pin_SER_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_SER_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("a594e28f-4ac7-4734-8f5f-388dfe3fa539"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
